...
atomic64_t each_exit_counter[69]= {0};
EXPORT_SYMBOL(each_exit_counter);

uint64_t cycles;

atomic_long_t total_cpu_cycles[69];
...
int kvm_emulate_cpuid(struct kvm_vcpu *vcpu)
{
	...
	if(ecx==3 || ecx==4 || ecx==5 || ecx==6 || ecx==16 || ecx==11 || ecx==17 || ecx==16 || ecx==33 || ecx==34 || ecx==51 || ecx==54 || ecx==63 || ecx== 64 || ecx==66 || ecx== 67 ) {
				...
				eax = atomic64_read(&each_exit_counter[ecx]);
	...
	if(ecx==3 || ecx==4 || ecx==5 || ecx==6 || ecx==16 || ecx==11 || ecx==17 || ecx==16 || ecx==33 || ecx==34 || ecx==51 || ecx==54 || ecx==63 || ecx== 64 || ecx==66 || ecx== 67 ) {
				...
				cycles = atomic64_read(&total_cpu_cycles[ecx]);
						ebx = (cycles >> 32);
